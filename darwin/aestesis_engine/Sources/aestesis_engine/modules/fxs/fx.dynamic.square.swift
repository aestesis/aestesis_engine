//
//  fx.dynamic.square.swift
//  FlutterAlib
//
//  Created by renan jegouzo on 24/08/2024.
//
...
class FxDynamicSquare: Fx {
    ...
    override func render(time: Double, dtime: Double, fps:Double, audio: AudioAnalyzer.Info, input: Bitmap, output: Bitmap, level: Double,
        ...
        updateAudio(audio: audio, level: level)
    ...
    func updateAudio(audio:AudioAnalyzer.Info, level:Double) {
