...
class Disco: Reflex {
    ...
    override init(parent: NodeUI) {
        ...
        sprite = Bitmap(parent: self, path: "assets/Sprites/sprite-32.png", bundle: Bundle.aestesis)
    }
    ...
    override func draw(
        ...
        if let sprite = sprite {
            ...
            for _ in 1...ns {
                ...
                ps.append(
                    PointSprite(
                        position: center + Point(cos(a), sin(a)) * r, scale: scale,
                        color: Color(a: 1, l: 0.7)))
                ps.append(
                    PointSprite(
                        position: center + Point(cos(a + ß.π), sin(a + ß.π)) * r, scale: scale,
                        color: Color(a: 1, l: 0.7)))
                a += da
                b += db
            }
